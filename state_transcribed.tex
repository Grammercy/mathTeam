...
\item Let $x$ be a positive integer such that $x<100$. For how many distinct values of $x$ is $\sin(2x)+1>2$?\\
...
\begin{center}
\includegraphics[width=0.5\linewidth]{diagrams/state_2010_q20.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\linewidth]{diagrams/state_2011_q05.png}
\end{center}
\(\text{Solution: }1464\)
...
\begin{center}
\includegraphics[width=0.5\linewidth]{diagrams/state_2011_q09.png}
\end{center}
\(\text{Solution: }167\)
...
\item An apartment rental company has \(3000\) apartments available, and \(1900\) are presently rented at \(\$950\) per month. The company has decided that it will only raise or lower the rent per month on all apartments by integral increments of \(\$40\). A survey has shown that, so long as there are apartments available, for each \(\$40\) drop in rent per month for every apartment, there will be \(99\) new tenants. Find the number of dollars in the monthly rent that will maximize total income. \quad\textbf{Solution:} \(\$870\)
...
\]
form a geometric progression. The sum of the reciprocals of the roots is \(242\). Find the absolute value of \(e\). Express your answer as a common fraction reduced to lowest terms. \quad\textbf{Solution:} \(\frac{1}{1889568}\)
...
k^3+w^3+p^3=1302^3.
\]
Find the value of \(k+w+p\). \quad\textbf{Solution:} \(1932\)
\end{enumerate}
...
\item $\triangle AEU$ is equilateral, and $\triangle RTG$ has a right angle at $T$. The diagram places $R$ on $\overline{AE}$, $T$ on $\overline{AU}$, and $G$ on $\overline{EU}$. If $RA=1$, $AT=4$, and $UT=2$, find the exact length of $UG$. Express your answer as a common or improper fraction reduced to lowest terms. 
\begin{center}
\includegraphics[width=0.5\linewidth]{diagrams/state_2014_q10.png}
\end{center}
\textbf{Solution:} $\frac{14}{5}$.
...
\item For all real numbers $x$, $f(x^2+1)+3f(22-5x)=x^2+2$. Find $f(17)$. \textbf{Solution:} $-\frac98$ (the key also prints $-\frac98$ or $-1.125$).
...
\item Quadrilateral $ABDC$ is a rhombus with sides of length $15$. Define $\operatorname{rat}(\theta)$ to be the length of the diagonal that bisects the angle $\theta$ divided by the length of the other diagonal. If $\operatorname{rat}(\angle ABD)=\frac43$, determine the degree measure of $\angle ACD$. Express your answer rounded to the nearest degree. 
\begin{center}
\includegraphics[width=0.5\linewidth]{diagrams/state_2015_q19.png}
\end{center}
\textbf{Solution:} $74^\circ$.
\item Triangle $ABC$ is isosceles with $\overline{AB}\cong\overline{AC}$. $D$ lies on $\overline{AB}$ and $E$ lies on $\overline{AC}$. If $\angle CAB=24^\circ$, $\angle EBC=51^\circ$, and $\angle DCB=54^\circ$, determine the degree measure of $\angle EDC$. Report your answer as a decimal rounded to the nearest tenth of a degree. 
\begin{center}
\includegraphics[width=0.5\linewidth]{diagrams/state_2015_q20.png}
\end{center}
\textbf{Solution:} $45.3^\circ$.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \textbf{Problem.} Circle $O$ is inscribed in $\triangle ABC$ with $E$, $F$, and $G$ the respective points of tangency. $AB=8$, $BC=10$, and $CA=12$. Determine the radian measure of $\angle EOF$. Express your answer as a decimal rounded to the nearest thousandth.\quad 
\begin{center}
\includegraphics[width=0.5\linewidth]{diagrams/state_2017_q06.png}
\end{center}
\textbf{Solution:} $1.696$.
...
\begin{center}
\includegraphics[width=0.5\linewidth]{diagrams/state_2017_q17.png}
\end{center}
\textbf{Solution:} $23$.
